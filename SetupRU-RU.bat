...
title Batch Office Installer v1.0.9 от MaximeriX && set DebugMode=0
cls
echo ^|
echo ^|   ╠══╦════════════════════════════════════════════════════════════════════════╦══╣
echo ^|      ║ Batch Office Installer v1.0.9 от                                       ║
echo ^|      ╠════════════════════════════════════════════════════════════════════════╣
echo ^|      ║                                                                        ║
echo ^|      ║  ███╗   ███╗ █████╗ ██╗  ██╗██╗███╗   ███╗███████╗██████╗ ██╗██╗  ██╗  ║
echo ^|      ║  ████╗ ████║██╔══██╗╚██╗██╔╝██║████╗ ████║██╔════╝██╔══██╗██║╚██╗██╔╝  ║
...
echo ^|
echo ^|   ╠══╦══════════════════════════════════════════════════════════════════════════╦══╣
echo ^|      ║ Office включает - Access, Excel, OneDrive, OneNote, Outlook, PowerPoint, ║
echo ^|      ║ Project, Publisher, Teams, Visio и Word. (Можно изменить)                ║
echo ^|      ╠═══╦═══════╗                                                              ║
echo ^|      ║ 1 ║ Окей  ║                                                              ║
echo ^|      ║ 2 ║ Выход ║                                                              ║
echo ^|   ╠══╩═══╩═══════╩══╦═══════════════════════════════════════════════════════════╩══╣
...
if %OfficeInfo% == 2 echo ^| && echo ^| Выход... && echo ^| && timeout 1 >nul && exit
...
echo ^|
echo ^|   ╠══╦════════════════════════════════════════════════════╦══╣
echo ^|      ║ Выберите версию Office, которую хотите установить. ║
echo ^|      ╠═══╦═══════════════════════════╗                    ║
...
echo ^|
echo ^|   ╠══╦═══════════════════════════════════════════════════╦══╣
echo ^|      ║ Выберите программы, которые вы хотите установить. ║
echo ^|      ╠═══╦════════════╦════╦══════════════╗              ║
...
echo ^|      ║ 6 ║ PowerPoint ║ A  ║ Оставить всё ║              ║
echo ^|   ╠══╩═══╩════════════╩════╩═══╦══════════╩══════════════╩══╣
echo ^|                                ║   
set /p AppsInstall="|   Введите ваш выбор (2 6 т.д.) ╚→ : "
...
if exist %ConfigPath% (echo ^| Конфигурация сохранена в ^> %ConfigPath%
) else (
    echo ^| Ошибка сохранения конфигурации
    echo ^| Выход...
    timeout 7 >nul && exit
)
...
if %DebugMode% == 0 (if %Teams%==1 (cls
        echo ^|
        echo ^|   ╠══╦════════════════════════════════╦══╣
        echo ^|      ║ Скачивание MSTeamsSetup.exe... ║
        echo ^|   ╠══╩════════════════════════════════╩══╣
        echo ^|
        curl -L -s -o %TeamsPath% https://go.microsoft.com/fwlink/?linkid=2281613&clcid=0x409
        if exist %TeamsPath% (echo ^| Успешно скачено в %TeamsPath%
            timeout 1 >nul
            start %TeamsPath%
            cls
            echo ^|
            echo ^|   ╠══╦═════════════════════╦══╣
            echo ^|      ║ Скачивание Teams... ║
            echo ^|   ╠══╩═════════════════════╩══╣
            echo ^| && timeout 1 >nul && goto TeamsCheckLoop
        ) else (echo ^| Ошибка при скачивании MSTeamsSetup.exe.
            echo ^| Выход...
            timeout 7 >nul && exit)
...
) else (echo ^| Ошибка при скачивании OfficeExtracter.exe
    echo ^| Выход...
    timeout 10 >nul && exit)
...
) else ( echo ^| Выход... && timeout 2 >nul && exit)
@endlocal