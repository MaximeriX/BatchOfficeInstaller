...
echo ^|
echo ^|   ╠══╦═══════════════════════════════════════════════════════════════════════════════════╦══╣
echo ^|      ║ Office - включает Access, Excel, OneDrive, OneNote, Outlook, PowerPoint, Project, ║
echo ^|      ║ Publisher, Teams, Visio и Word. (Можно изменить)                                  ║
echo ^|      ╠═══╦═══════╗                                                                       ║
echo ^|      ║ 1 ║ Окей  ║                                                                       ║
echo ^|      ║ 2 ║ Выход ║                                                                       ║
echo ^|   ╠══╩═══╩═══════╩══╦════════════════════════════════════════════════════════════════════╩══╣
...
echo ^|   ╠══╩═══╩══════════╦════════════════╩════════════════════╩══╣
echo ^|                     ║
choice /C:123456 /M "|   Введите ваш выбор ╚→ :" /N
